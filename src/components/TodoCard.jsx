...
import { CheckCircle, Circle, Clock, AlertTriangle, Trash2, RefreshCw, Coins } from 'lucide-react';
            ...
            <div className="flex justify-between items-start gap-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button 
                        ...
                        className="p-1.5 text-gray-600 hover:text-red-500 transition-colors opacity-100 md:opacity-0 md:group-hover:opacity-100"
                        title="Delete"
                    >
